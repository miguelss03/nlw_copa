    ...
    <div className='max-w-[1124px] h-screen mx-auto grid grid-cols-2 gap-28 items-center'>
      <main>
        ...
        <form onSubmit={createPool} className='mt-10 flex gap-2'>
          <input
            className='flex-1 px-6 py-4 text-gray-100 rounded bg-gray-800 border-2 border-gray-600 text-sm'
            required
            type="text"
        ...
        <p className="mt-4 text-sm text-gray-300 leading-relaxed">
          Após criar seu bolão, voce receberá um codigo
          único que poderá usar para convidar seus amigos
        </p>
      ...
      <Image
        src={appPreviewImg}
        alt="Dois celulares exibindo a previa do aplicativo"
        quality={100}
      />
    </div>
  )
